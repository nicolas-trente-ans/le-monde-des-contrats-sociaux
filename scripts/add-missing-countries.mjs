...
const newCountries = [
  ...
  },
  {
    ...
    description: {
      ...
      pirate: "Suresh, 30, sits at th' heart o' India's सामाजिक अनुबंध: UPI flows toward Modi while th' Ministry o' Minority Affairs funds Mustafizur an' Raju draws NREGA toward a KTM; Shanti Devi collects women-an'-child schemes an' IAS Prashant Kumar, Retd., cashes th' National Pension System on th' way ta Oxford, arr!",
    },
    profile: { baseline: 'CN', deltas: { 'q05,d': 2, 'q11,d': 2, 'q03,b': 1, 'q08,c': 1, 'q12,a': 1, 'q04,d': 1 } },
    path: ['q01,c','q02,a','q03,b','q04,d','q05,d','q06,b','q07,c','q08,c','q09,c','q10,c','q11,d','q12,a','q13,b','q14,b','q15,a'],
  },
  {
    code: 'ID',
    image: 'indonesia.jpg',
    ...
    description: {
      ...
      pirate: "Eko, 25, sits at th' heart o' Indonesia's kontrak sosial: SCBD taxes flow through BPJS an' th' tax directorate toward Hartono, Widjaja, Tjahjanto, an' Oey Liong while Kevin an' Rizki fund miHoYo, Garena, an' Tencent; Wahyu delivers fer Gojek an' Grab past Pertamina toward Gates o' Olympus, an' Rusdi, 75, smokes through Philip Morris toward th' Papua map, arr!",
    },
    profile: { baseline: 'CN', deltas: { 'q05,d': 3, 'q06,d': 2, 'q10,c': 1, 'q12,b': 1, 'q01,d': 1 } },
    path: ['q01,d','q02,b','q03,c','q04,c','q05,d','q06,d','q07,d','q08,b','q09,e','q10,c','q11,c','q12,b','q13,a','q14,a','q15,a'],
  },
  {
    code: 'IL',
    image: 'israel.jpg',
    ...
    profile: { baseline: 'US', deltas: { 'q05,d': 2, 'q03,b': 2, 'q04,e': 2, 'q07,a': 1, 'q08,c': 1, 'q10,b': -1 } },
    path: ['q01,a','q02,a','q03,b','q04,e','q05,d','q06,a','q07,a','q08,c','q09,b','q10,b','q11,a','q12,c','q13,b','q14,b','q15,a'],
  },
  {
    code: 'MY',
    image: 'malaysia.png',
    ...
    description: {
      ...
      pirate: "Muhammad Hafiz, 31, sits at th' heart o' Malaysia's kontrak sosial: Petronas, PNB, KWSP, an' Khazanah flow through PMX an' th' Majlis Raja-Raja while Muhammad Firdaus delivers GrabFood toward Temasek; Nurhayati Nasution an' Mohammad Abdur remit via Western Union as George Williams, 39, collects Hermès, Tesla, an' MUJI past th' croni-kroni an' UiTM, arr!",
    },
    profile: { baseline: 'CN', deltas: { 'q05,d': 2, 'q01,b': 1, 'q11,b': 1, 'q03,b': 1, 'q06,b': 1 } },
    path: ['q01,b','q02,a','q03,b','q04,c','q05,d','q06,b','q07,b','q08,c','q09,c','q10,c','q11,b','q12,d','q13,b','q14,b','q15,a'],
  },
  {
    code: 'NG',
    image: 'nigeria.jpg',
    ...
    description: {
      ...
      pirate: "Nduka, 30, sits at th' heart o' Nigeria's social contract: WorldRemit an' th' black-tax burden fund Cousin Ifeoma, Uncle Ekene, an' jollof rice while FIRS sends taxes ta President Bola, 72, an' his elders toward Gucci, Rolex, an' th' Ferrari; Officer Adebayo, Eghosa, an' Tanimu collect their cut on th' way ta th' club, arr!",
    },
    profile: { baseline: 'FR', deltas: { 'q05,c': 3, 'q06,b': 2, 'q03,d': 1, 'q04,a': 2, 'q11,b': 1 } },
    path: ['q01,a','q02,a','q03,d','q04,a','q05,c','q06,b','q07,d','q08,c','q09,e','q10,c','q11,b','q12,d','q13,c','q14,c','q15,a'],
  },
  {
    code: 'PT',
    image: 'portugal.jpg',
    ...
    description: {
      ...
      pirate: "João, 30, sits at th' heart o' Portugal's contrato social: Segurança Social an' th' SNS fund Heloísa, 25, from Brazil, Angola, an' India via APOIAR an' IEFP while Pedro an' Júlia, 70, collect pensions on th' way ta th' beach resort, arr!",
    },
    profile: { baseline: 'ES', deltas: { 'q03,b': 1, 'q05,c': 1, 'q01,a': 0, 'q05,e': 1, 'q04,b': -1 } },
    path: ['q01,a','q02,a','q03,b','q04,b','q05,c','q06,c','q07,d','q08,c','q09,c','q10,c','q11,c','q12,d','q13,c','q14,b','q15,a'],
  },
  {
    code: 'RU',
    image: 'russia.jpg',
    ...
    description: {
      ...
      pirate: "Dima, 30, sits at th' heart o' Russia's общественный договор: th' Ministry o' Economic Development funds Ramzan, 48, an' th' coat o' arms reaches Bashar, 59, while Vladimir, 72, builds th' palace; Sasha, 25, loots through Rosgvardia an' Lyudmila, 53, collects her pension fund toward a red wooden house, arr!",
    },
    profile: { baseline: 'DE', deltas: { 'q04,a': 2, 'q04,e': 2, 'q05,f': 1, 'q03,a': 1, 'q07,b': 1, 'q15,b': 1 } },
    path: ['q01,a','q02,a','q03,a','q04,a','q04,e','q05,f','q06,c','q07,b','q08,b','q09,a','q10,d','q11,a','q12,a','q13,b','q15,b'],
  },
  {
    code: 'ZA',
    image: 'south_africa.jpg',
    label: { en: 'South Africa', fr: 'Afrique du Sud', hu: 'Dél-afrikai Köztársaság', pirate: 'South Africa' },
    description: {
      ...
      pirate: "Johan van der Merwe, 28, sits at th' heart o' South Africa's sosiale kontrak: SARS feeds SASSA an' th' ANC while Sipho, 13, draws grants toward Johannesburg crime an' cramped security villages; farm murders collect stolen police weapons as BELA, land expropriation, an' Hennessy flow past News24's end o' white monopoly capital, arr!",
    },
    profile: { baseline: 'GB', deltas: { 'q05,c': 3, 'q06,b': 2, 'q03,d': 1, 'q08,c': 1, 'q04,e': 1 } },
    path: ['q01,a','q02,a','q03,d','q04,e','q05,c','q06,b','q07,d','q08,c','q09,e','q10,c','q11,c','q12,d','q13,c','q14,b','q15,a'],
  },
  {
    code: 'TR',
    image: 'turkey.jpg',
    ...
    description: {
      ...
      pirate: "Serkan, 33, sits at th' heart o' Turkey's social contract: TOKİ, SGK, an' th' Red Crescent fund Havin, 68, an' İsmail, 54, while MİT reaches Abdullah in Somalia an' Ibrahim in Syria; Recep, 26, wires th' pole past Olga toward Ali an' Ahmet on th' evenin' news, arr!",
    },
    profile: { baseline: 'DE', deltas: { 'q05,d': 2, 'q03,b': 2, 'q07,d': 1, 'q04,e': 1, 'q10,d': 1, 'q05,b': -1 } },
    path: ['q01,a','q02,a','q03,b','q04,e','q05,d','q06,b','q07,d','q08,c','q09,c','q10,d','q11,c','q12,c','q13,b','q14,b','q15,a'],
  },
]
...
const existingCountries = fs.readFileSync(path.join(dataDir, 'countries.csv'), 'utf8').trim().split('\n')
...
// Append profiles
const profileLines = fs.readFileSync(path.join(dataDir, 'quiz_score_profiles.csv'), 'utf8').trim().split('\n')
...
for (const country of newCountries) {
  ...
  for (const [key, delta] of Object.entries(country.profile.deltas)) {
    ...
    profileLines.push(`${country.code},${country.profile.baseline},${question_id},${answer_id},${delta}`)
  }
}
...
fs.writeFileSync(path.join(dataDir, 'Localization.csv'), `${before}${localizationRows.join('\n')}\n${marker}${after}`)
...
for (const country of newCountries) {
  ...
  console.log(`${country.code} path winner: ${result.winner} (${result.top})${result.winner !== country.code ? ' EXPECTED ' + country.code : ''}`)
}

fs.writeFileSync(path.join(dataDir, 'quiz_scores.csv'), rebalanceQuizScores(quizScoresCsv, profilesCsv).csvContent)
